...
template <zink_multidraw HAS_MULTIDRAW, zink_dynamic_state HAS_DYNAMIC_STATE, bool BATCH_CHANGED,
          zink_trifan HAS_TRIFANS, bool STREAMOUT, zink_drawid DRAWID>
void
...
{
   ctx->draw_vbo[HAS_MULTIDRAW][HAS_DYNAMIC_STATE][BATCH_CHANGED][HAS_TRIFANS][STREAMOUT][DRAWID] = zink_draw_vbo<HAS_MULTIDRAW, HAS_DYNAMIC_STATE, BATCH_CHANGED, HAS_TRIFANS, STREAMOUT, DRAWID>;
}
